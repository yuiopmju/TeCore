...
import dev.sfcore.telegram.responses.ResponseHandler;
import dev.sfcore.telegram.server.JavaPlugin;
...
public class PluginsLoader {
    ...
    private static String readFileFromJar(String filePath) {
        ...
        try (InputStream inputStream = classLoader.getResourceAsStream(filePath)) {
            if (inputStream != null) {
                ...
                System.out.println("File not found for " + filePath);
            }
        } catch (IOException e) {
            System.err.println("Error while reading the file " + filePath + ": " + e.getMessage());
        }
        return null;
    }
}
